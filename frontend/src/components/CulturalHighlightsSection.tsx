  ...
  useEffect(() => {
    const loadCulturalHighlights = async () => {
      try {
        ...
        console.error(t("culturalHighlights.loadError"), error);
      } finally {
        setIsLoading(false);
      }
    };
          ...
          {culturalHighlights.map((highlight) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="mt-4 flex justify-between items-center">
                  <div className="flex items-center">
                    ...
                    <span className="ml-2 text-gray-700 font-medium">
                      ...
                      {t("culturalHighlights.reviews", {
                        count: highlight.reviews.length,
                      })}
                      )
                    </span>
                  </div>
                ...
                >
                  {t("culturalHighlights.viewDetails")}
                </Link>
              </div>
            </motion.div>
          ))}
